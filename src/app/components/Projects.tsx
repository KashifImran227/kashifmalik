    ...
    <main className="min-h-screen flex flex-col items-center bg-gradient-to-b from-[#08090A] via-[#022027] to-[#060606] p-6">
      ...
      <div className="flex flex-wrap justify-center gap-6 w-full max-w-6xl">
        {projectsData.map((project, index) => (
          <div
            key={index}
            className="flex flex-col w-full sm:w-[45%] md:w-[30%] lg:w-[20%] bg-[#00696d4f] rounded-lg overflow-hidden shadow-lg transition-transform duration-300 ease-in-out transform hover:scale-105 hover:bg-[#007B7D] hover:shadow-2xl"
          >
            <img
